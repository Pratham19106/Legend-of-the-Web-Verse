...
```bash
git clone https://github.com/YOUR-USERNAME/Legend-of-the-Web-Verse.git
```
...
```
git remote add upstream https://github.com/VJTI-Coding-Academy/Legend-of-the-Web-Verse.git
```
